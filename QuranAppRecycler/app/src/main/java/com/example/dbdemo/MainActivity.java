...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed(){
        if(drawerLayout.isDrawerOpen(GravityCompat.START)){
            ...
            Toast.makeText(getApplicationContext(),"NAVIGATION OPEN!!",Toast.LENGTH_LONG).show();

        }
        else
        {
            Toast.makeText(getApplicationContext(),"NAVIGATION CLOSE!!",Toast.LENGTH_LONG).show();
        }
    }
