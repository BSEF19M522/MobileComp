...
public class Surah_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.surah_list);
//        Intent intent=getIntent();
        QDH qdh=new QDH();


        SurahListAdapter myRecyclerAdapter = new SurahListAdapter(android.R.layout.simple_list_item_1, qdh.urduSurahNames);
